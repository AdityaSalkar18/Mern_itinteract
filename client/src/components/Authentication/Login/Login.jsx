...
<Link onClick={openModal}  class= "text-sm text-[#005A9C] hover:underline">
   Register With New Account
</Link>
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4  border-gray-200">
              ...
              <button type="button" onClick={toggleModal} class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" >
