    ...
    <>
      ...
      <div className="container mx-auto my-8  px-4">
        ...
        <div className="container mx-auto my-20 ">
          ...
          <div class="py-15 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">ITInteract</h1>
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">The platform that bridges the gap between IT students and industry professionals. Join, learn, and grow together for a brighter future in tech</p>
        ...
        <div className="conatiner mx-auto my-8 px-4">

          <div class="grid md:grid-cols-2 gap-8">
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">

              <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Start with Student Account</h2>
              ...
              <a href="#" class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Build Profile

              </a>
            </div>
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">

              <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Start with User Account</h2>
              <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">Static websites are now used to bootstrap lots of websites and are becoming the basis for a variety of tools that even influence both web designers and developers.</p>
              <a href="#" class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Build Profile
        ...
        <div className="container mx-auto my-8 px-12 h-[500px]">
          ...
          <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white dark:bg-gray-900 text-gray-900 dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
            ...
            <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
              <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                <p class="mb-2 text-gray-500 dark:text-gray-400">ITInteract empowers users to connect, collaborate, and learn from real-world tech challenges. By offering real-time communication, project-based tasks, and mentorship from industry professionals, the platform bridges the gap between academic knowledge and industry practices, preparing students for success in the tech world.</p>
            ...
            <h2 id="accordion-flush-heading-2">
              <button type="button" class="flex items-center justify-between w-full py-5 font-medium rtl:text-right text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400 gap-3" data-accordion-target="#accordion-flush-body-2" aria-expanded="false" aria-controls="accordion-flush-body-2">
                <span>Domains ITInteract Include</span>
                <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5" />
                </svg>
              </button>
            ...
            <h2 id="accordion-flush-heading-3">
              <button type="button" class="flex items-center justify-between w-full py-5 font-medium rtl:text-right text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400 gap-3" data-accordion-target="#accordion-flush-body-3" aria-expanded="false" aria-controls="accordion-flush-body-3">
                <span>Sub-Domains ITInteract Include</span>
                <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                  <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5" />
                </svg>
              </button>
            ...
            <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
              <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                ...
                <ul class="ps-5 text-gray-500 list-disc dark:text-gray-400">
                  <li><p>Backend Development,

                    Frontend Development,

                    Full Stack Development,

                    Mobile App Development </p></li>
                  <li><p>Data Analysis,
                    ...
                    Data Engineering </p></li>
                  <li><p>Security Analysis,
                  ...
                  <li><p>Database Administration,
                    ...
                    Data Analysis </p></li>
                  <li><p>Cloud Engineering,

                    Cloud Architecture,

                    Cloud Security,

                    Cloud Administration </p></li>
        ...
        <div className="contianer  mx-auto my-8  ">
