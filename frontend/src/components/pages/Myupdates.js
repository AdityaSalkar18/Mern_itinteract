                                    ...
                                    <div className="card  text-start">
                                        <div className="card-header">
                                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                                <h5>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-person-circle mx-2" viewBox="0 0 16 16">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <p className="card-text"><small className="text-body-secondary">{update.date} [{update.sd}]</small></p>
                                        </div>
                                    </div>
                                </Link>
                            </div>
